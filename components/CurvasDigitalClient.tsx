...
export default function CurvasDigitalClient({ data }: CurvasDigitalClientProps) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f1f5f9", fontFamily: "'Outfit', sans-serif" }}>
      ...
      <div className="no-print" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
          ...
          >
            ...
            <span>Ver Carné de Vacunación</span>
          </Link>
      ...
      <div style={{ maxWidth: "980px", margin: "24px auto", padding: "0 16px 40px 16px" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <h1 style={{ margin: "4px 0 0 0", fontSize: "24px", fontWeight: "800", color: "#0A4D5C", letterSpacing: "-0.02em" }}>
