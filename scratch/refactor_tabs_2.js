...
// The IDENTIDAD block was successfully replaced? Let's check!
// Actually, let me check if Identidad was replaced.
if (!content.includes('Información básica, foto y datos de contacto.')) {
...
content = content.replace(/\{\/\* ── HERO ──────────────────────────────────────── \*\/\}[\s\S]*?\{\/\* ── MENÚ \/ ESPECIALIDAD ──────────────────────── \*\/\}/, 
`{/* ── HERO Y CONTENIDO ─────────────────────────────────── */}
            {activeTab === "hero" && (
              <div>
                <div style={{ padding: "24px 28px", borderBottom: "1px solid var(--slate-200)" }}>
...
content = content.replace(/\{\/\* ── MENÚ \/ ESPECIALIDAD ──────────────────────── \*\/\}[\s\S]*?\{\/\* ── LÍNEAS DE INVESTIGACIÓN ───────────────────── \*\/\}/, 
